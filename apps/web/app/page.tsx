      ...
      <div className="mx-auto w-full max-w-3xl space-y-6 md:space-y-10">
        ...
        <div className="space-y-4 text-sm leading-relaxed text-text-secondary md:space-y-5 md:text-base">
          ...
          <p>
            ...
            functional, not atmospheric. The crosshair cursor, the CRT scan lines, the grid overlays
            — these aren&apos;t nostalgia. They&apos;re a commitment to treating the interface as
            what it is: <span className="text-white">a machine for communicating information</span>.
